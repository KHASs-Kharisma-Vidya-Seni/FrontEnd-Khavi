          ...
          <div className="ml-auto w-full bg-[#2E323A] px-10 py-12  2xl:w-[62%] 2xl:py-20 ">
            <div className="flex h-full w-full flex-col items-center lg:flex-row">
              ...
              <p className="w-full text-left text-lg text-[#F4F4F4]">
                Selamat datang di <span className="text-[#CDB16E]">KHASs</span>,
                tempat di mana gaya rambut yang sempurna dan perawatan rambut
                yang tepat menjadi kenyataan. Kami hadir dengan misi untuk
                memberikan inspirasi, edukasi, dan panduan praktis agar Anda
                dapat menemukan gaya rambut dan merawatnya dengan baik. Temukan
...
const BenefitSection = () => {
      ...
      <motion.div className="relative flex w-full items-center justify-center">
        ...
        <motion.h1
          ...
          transition={{
            duration: 0.8,
            ease: [0.22, 1, 0.36, 1],
            delay: 0.2, // Delay the text animation for a smoother effect
          }}
          className="relative z-10 text-center text-5xl font-extrabold text-[#2E323A]">
  ...
  const Word = ({ value }: { value: string }) => {
    ...
    return <p ref={element} className="text-4xl">{value}</p>;
  };

  return (
    <div className="container bg-white py-20 lg:container">
      {/* 2xl:px-40 */}
      <div className="px-0 2xl:px-10">
        <AnimateCool />
        <div className="mt-10 flex h-full w-full flex-col items-center justify-center gap-8 lg:mt-16 lg:flex-row lg:gap-20">
          ...
          <div className="w-full lg:w-3/6">
            {/* <p className="text-justify  text-xl leading-relaxed text-[#2E323A] sm:text-lg lg:text-xl xl:text-2xl">
              Gaya rambut mencerminkan kepribadian dan kepercayaan diri. Dengan
              tampilan yang tepat, Anda bisa mengekspresikan diri dengan percaya
              diri, memengaruhi kesan sosial, dan membuka peluang di dunia
              profesional. Merawat rambut adalah investasi dalam kesejahteraan
              fisik dan mental Anda.
            </p> */}
            <Word
              value="Gaya rambut mencerminkan kepribadian dan kepercayaan diri. Dengan
              tampilan yang tepat, Anda bisa mengekspresikan diri dengan percaya
              diri, memengaruhi kesan sosial, dan membuka peluang di dunia
              profesional. Merawat rambut adalah investasi dalam kesejahteraan
              fisik dan mental Anda.ss"
            />
          </div>
        </div>
      </div>
      ...
      <div className="px-0 lg:px-36">
        <div className="flex flex-col items-center">
          ...
          <p className="mb-12 mt-3 w-full text-center text-xl leading-relaxed text-[#2E323A] md:text-2xl lg:w-11/12">
            ...
            cepat bentuk wajah seseorang menghasilkan informasi tentang proporsi
            wajah dan gaya rambut
          </p>
        </div>
      ...
      <div className="justify-cente flex flex-col items-center px-0 lg:px-36">
        <div className="flex flex-col items-center justify-center gap-3 text-[#2E323A]">
          ...
          <p className="text-center text-2xl ">
            Ini adalah pendapat dari seseorang yang telah merasakan manfaat dari
            situs web ini.
          </p>
        </div>
