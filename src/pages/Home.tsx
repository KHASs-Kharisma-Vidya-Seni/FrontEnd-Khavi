      ...
      <div id="home" className="relative scroll-smooth">
        <div id="1" className="flex overflow-hidden">
          ...
          >
            ...
            <h1 className="ml-0 text-5xl font-extrabold text-[#CDB16E] md:ml-52 lg:ml-72 lg:text-8xl">Rambutmu</h1>
          </motion.div>
          <motion.figure
            initial={{
              opacity: 0,
            ...
            <div className="ml-auto w-full bg-[#2E323A] px-10 py-12 2xl:w-[62%] 2xl:py-20">
              <div className="flex h-full w-full flex-col items-center lg:flex-row">
                ...
                <p className="w-full text-left text-lg text-[#F4F4F4]">
                  Selamat datang di <span className="text-[#CDB16E]">KHASs</span>, tempat di mana gaya rambut yang
                  sempurna dan perawatan rambut yang tepat menjadi kenyataan. Kami hadir dengan misi untuk memberikan
                  inspirasi, edukasi, dan panduan praktis agar Anda dapat menemukan gaya rambut dan merawatnya dengan
                  baik. Temukan rahasia cantiknya rambut Anda bersama kami!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="px-0 2xl:px-40">
          ...
          <div className="mt-10 flex h-full w-full flex-col items-center justify-center gap-8 lg:mt-16 lg:flex-row lg:gap-20">
            <figure className="relative h-full w-full px-6 lg:w-3/6 lg:px-0">
              <img className="h-full w-full rounded-lg object-cover" src="/images/women-hair-salon.png" alt="" />
            ...
            <div className="w-full lg:w-3/6">
              <p className="text-justify text-xl leading-relaxed text-[#2E323A] sm:text-lg lg:text-xl xl:text-2xl">
                Gaya rambut tidak hanya berpengaruh pada penampilan, tetapi juga pada kepercayaan diri dan ekspresi
                diri. Dengan gaya rambut yang tepat, seseorang bisa merasa lebih percaya diri dan mengekspresikan
                kepribadian mereka dengan lebih baik. Selain itu, penampilan yang terawat juga dapat memengaruhi
                bagaimana orang lain memandang seseorang, terutama dalam konteks profesional. Jadi, gaya rambut memiliki
                manfaat yang signifikan dalam meningkatkan kepercayaan diri dan kesan sosial.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="px-0">
          <div className="container flex flex-col items-center gap-1 pb-6 pt-20">
            ...
            <p className="w-full text-center text-xl leading-relaxed text-[#B8B8C4] lg:w-5/6 lg:text-2xl">
              Jelajahi artikel ini untuk mendapatkan wawasan mendalam tentang teknologi face scanner dan temukan
              informasi menarik terkait tips dan trik perawatan rambut.
            </p>
          </div>
            ...
            <div className="flex flex-col items-center justify-center overflow-hidden rounded-xl bg-white lg:flex-row">
              <div className="w-full p-10 lg:w-3/6">
                ...
                <p className="leading-description text-xl text-gray-500">
                  Bergabunglah dalam perjalanan ini untuk menemukan tren terbaru dalam dunia hairstyle, serta
                  mendapatkan saran praktis yang dapat Anda terapkan sehari-hari. Jelajahi artikel ini sekarang !!
                </p>
                {/* Button */}
              </div>
              <figure className="w-full lg:w-3/6">
                <img src="/images/artikel-man-three.png" className="h-[29.3125rem] w-[210.5rem] object-cover" alt="" />
              </figure>
            </div>
          </div>
        </div>
        ...
        <div className="px-0 xl:px-36">
          <div className="flex flex-col items-center">
            ...
            <p className="mb-12 mt-3 w-full text-center text-xl leading-relaxed text-[#2E323A] md:text-2xl lg:w-11/12">
              Sebuah teknologi canggih yang memungkinkan pemindaian dan analisis cepat bentuk wajah seseorang
              menghasilkan informasi tentang proporsi wajah dan gaya rambut
            </p>
          </div>
          ...
          <div className="mx-auto h-full w-full overflow-hidden rounded-[1.25rem] bg-[#2E323A]">
            <figure className="h-full w-full overflow-hidden lg:h-[400px]">
              <img className="center h-full w-full object-cover object-right-top" src="/images/face-scane.png" alt="" />
            </figure>
            ...
            <div className="flex flex-col items-center gap-1 px-6 py-10 md:px-10">
              ...
              <p className="mb-4 w-full text-center text-lg font-normal text-[#808080] md:w-4/6 md:text-2xl lg:w-5/6">
                Temukan gaya rambut ideal Anda dengan teknologi scan wajah! Rekomendasi personal dan visualisasi instan
          ...
          <div className="mx-auto my-10 w-full rounded-[3.125rem] bg-[#2E323A] px-[3.75rem] py-[1.88rem] drop-shadow-md">
            ...
            <div className="mt-4">
              <p className="font-normal leading-loose text-[#CAC5C5] lg:text-xl">
                "Situs ini memberikan pemindaian wajah yang cepat dan akurat dengan antarmuka pengguna yang mudah
                digunakan. Saya sangat puas Deng hasilnya, terutama dalam analisis proporsi wajah dan rekomendasi gaya
