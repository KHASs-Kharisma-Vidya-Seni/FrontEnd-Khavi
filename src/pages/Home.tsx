export default function HomeAnother() {
  return (
    <div className="">
      ...
      <div className="container bg-white py-20 lg:container">
        <div className="px-0 lg:px-40">
          ...
          <div className="mt-10 flex h-full w-full flex-col items-center justify-center gap-8 lg:mt-28  lg:flex-row lg:gap-20">
          ...
          <div id="card-artikel" className="container">
            <div className="flex flex-col items-center justify-center overflow-hidden rounded-xl bg-white lg:flex-row">
              <div className="w-full p-10 lg:w-3/6">
                ...
                <p className="text-xl leading-description text-gray-500">
