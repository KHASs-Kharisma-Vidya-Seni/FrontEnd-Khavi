...
import { TagPopuler, Card } from "@/components/ui/forum";
...
export default function Forum() {
  ...
  const comments = [
    {
      ...
      profileImage: "/images/Ellipse-2.png",
      name: "User1",
      comment: "Komen pertama di post 1",
      likes: 5,
    },
    {
      postId: 1,
    ...
    },
    {
      ...
      profileImage: "/images/Ellipse-2.png",
      name: "User3",
      comment: "Komen pertama di post 2",
      likes: 2,
    },
    {
      postId: 3,
      ...
      profileImage: "/images/Ellipse-2.png",
      name: "User4",
      comment: "Komen pertama di post 3",
      likes: 8,
    },
    {
      postId: 3,
  ...
  return (
    <div className="flex pt-8 xl:container">
      <div className="w-56">
        <div className="fixed">
          <div className="mt-[-2rem] block xl:hidden">
            <Sidebar />
          </div>
          <div className="w-62 left-24 top-[8rem] hidden space-y-3.5 transition xl:block">
            <div className="relative flex w-full rounded-[0.625rem] bg-shark-900 p-5">
              <input
                type="text"
